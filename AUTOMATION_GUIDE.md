...
- [OpenTelemetry 2025 自动化系统使用指南](#opentelemetry-2025-自动化系统使用指南)
  - [目录](#目录)
  - [🎉 问题解决](#-问题解决)
  - [🚀 快速开始](#-快速开始)
    - [方法1: 一键运行（推荐）](#方法1-一键运行推荐)
    - [方法2: 快速更新](#方法2-快速更新)
    - [方法3: 单独运行特定任务](#方法3-单独运行特定任务)
  - [📋 自动化功能详解](#-自动化功能详解)
    - [1. 智能文档管理 (`smart_document_manager.py`)](#1-智能文档管理-smart_document_managerpy)
    - [2. 自动文档更新器 (`auto_document_updater.py`)](#2-自动文档更新器-auto_document_updaterpy)
    - [3. 目录生成器 (`auto_generate_toc.py`)](#3-目录生成器-auto_generate_tocpy)
    - [4. 导航更新器 (`auto_update_navigation.py`)](#4-导航更新器-auto_update_navigationpy)
  - [🎯 使用场景](#-使用场景)
    - [日常维护](#日常维护)
    - [添加新文档后](#添加新文档后)
    - [发现文档结构问题时](#发现文档结构问题时)
  ...
  - [📊 系统特性](#-系统特性)
    ...
    - [错误恢复](#错误恢复)
  - [🔧 配置选项](#-配置选项)
    - [配置文件: `scripts/document_config.yaml`](#配置文件-scriptsdocument_configyaml)
    - [缓存文件: `scripts/.document_cache.json`](#缓存文件-scriptsdocument_cachejson)
  - [📈 性能表现](#-性能表现)
    - [执行效率](#执行效率)
    - [资源使用](#资源使用)
  - [🎉 使用效果](#-使用效果)
