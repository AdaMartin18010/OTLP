---
title: OpenTelemetry AWS 集成指南
description: OpenTelemetry AWS 集成指南 详细指南和最佳实践
version: OTLP v1.9.0
date: 2026-03-17
author: OTLP项目团队
category: 工具生态
...
| 云平台 | 文档 | 典型组件 |
|--------|------|----------|
| AWS | 本文档 | ADOT、EKS、Lambda、X-Ray、CloudWatch |
| GCP | [02_GCP集成指南](./02_GCP集成指南.md) | GCP 可观测性 |
| Azure | [03_Azure集成指南](./03_Azure集成指南.md) | Azure Monitor |
| 多云对比 | [03_多云平台深度对比分析](./03_多云平台深度对比分析.md) | - |
