---
title: OpenTelemetry Azure 集成指南
description: OpenTelemetry Azure 集成指南 详细指南和最佳实践
version: OTLP v1.9.0
date: 2026-03-17
author: OTLP项目团队
category: 工具生态
...
**本模块思维表征**：云平台集成的选型与矩阵见 [📊 多维思维表征体系 §10](../../📊_多维思维表征体系_2025.md#10-按文档模块的思维表征索引)。云平台对比见 [03_多云平台深度对比分析](./03_多云平台深度对比分析.md)。
