---
title: OpenTelemetry Collector v0.117.0 → v0.147.0 完整变更日志
description: OpenTelemetry Collector v0.117.0 → v0.147.0 完整变更日志 详细指南和最佳实践
...
status: published
---
# OpenTelemetry Collector v0.117.0 → v0.147.0 完整变更日志
